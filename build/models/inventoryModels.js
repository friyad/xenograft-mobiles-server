...
exports.InventoriesModel = exports.inventorySchema = exports.smartPhoneSchema = void 0;
...
exports.inventorySchema = new mongoose_1.default.Schema({
    userID: String,
    smartPhones: [exports.smartPhoneSchema],
});
exports.InventoriesModel = mongoose_1.default.model("inventories", exports.inventorySchema);
